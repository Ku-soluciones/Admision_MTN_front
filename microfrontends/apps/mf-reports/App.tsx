  ...
  <header className="border-b border-amber-200 bg-white">
    <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-4 md:flex-row md:items-end md:justify-between md:px-6">
      <div>
        ...
        <h1 className="font-serif text-2xl font-bold text-slate-900">Reportes</h1>
        <p className="text-sm text-slate-600">Proyecto aislado para dashboards de reporteria y exportaciones.</p>
      </div>

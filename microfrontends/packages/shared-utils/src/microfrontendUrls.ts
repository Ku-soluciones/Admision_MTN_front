import { resolveEnvironmentDomain } from '../../backend-sdk/src/index';
...
export const microfrontendUrls = {
  ...
  guardianRegister: buildUrl('guardian', '/apoderado/login').replace('/#/apoderado/login', '/apoderado/login?register=1'),

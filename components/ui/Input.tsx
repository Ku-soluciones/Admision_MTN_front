            ...
            <div className="relative">
                <input
                    ...
                    className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 transition-all duration-200 ${
                        ...
                        error
                            ? 'border-rojo-sagrado focus:ring-rojo-sagrado focus:ring-opacity-50 focus:shadow-lg'
                            : 'border-gray-300 focus:border-azul-monte-tabor focus:ring-azul-monte-tabor focus:ring-opacity-20 focus:shadow-md hover:border-gray-400'
                    }`}
                    {...props}
                />
                {shouldShowToggle && (

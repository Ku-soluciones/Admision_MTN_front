...
export function ConnectedGroupObservationConsole({ profile }: Props) {
  ...
  return (
    <div className="space-y-5">
      {/* Header */}
      <div className="flex flex-wrap items-center justify-between gap-4 rounded-xl border border-amber-200 bg-gradient-to-r from-amber-800 to-amber-900 p-4 text-white">
        ...
        <button
          ...
          className="rounded-lg bg-white px-3 py-2 text-xs font-black text-amber-900 hover:bg-amber-50"
        >
          Actualizar
        </button>
      </div>
            ...
            <div className="space-y-3">
              {assignments.map((assignment) => {
                ...
                const isCompleted = assignment.reports.every((r) =>
                  ["COMPLETED", "SUBTED", "VALIDATED", "LOCKED"].includes(r.status),
                );
                return (
                  <button
          ...
          <section className="rounded-2xl border border-slate-200 bg-white">
            <div className="grid gap-4 p-5 md:grid-cols-3">
              {selectedAssignment.reports.map((report, index) => (
                ...
                >
                  <span className="absolute left-3 top-3 grid h-7 w-7 place-items-center rounded-full bg-amber-900 text-xs font-black text-white">
                    {index + 1}
                  </span>
        ...
        <div>
          <div className="mb-5 flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <h2
                ...
                style={{ fontFamily: "Montserrat, system-ui, sans-serif" }}
              >
                Evaluación de Observación Grupal
              </h2>
          ...
          {isCurrentBlocked && minutesUntilStart !== null && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm">
              <div className="mx-4 max-w-sm rounded-2xl border border-amber-200 bg-gradient-to-br from-amber-800 to-amber-900 p-8 text-center text-white shadow-2xl">
                ...
                <button
                  onClick={() => navigate("/prekinder/evaluador/group-observation")}
          ...
          <div className="grid gap-5 xl:grid-cols-[270px_1fr]">
            ...
            <aside className="h-fit rounded-2xl border border-slate-200 bg-gradient-to-b from-amber-800 to-amber-900 p-4">
              <h3 className="mb-3 px-2 text-xs font-black uppercase tracking-widest text-amber-200">
                Postulantes
              </h3>
            ...
            <section className="rounded-2xl border border-slate-200 bg-white shadow-lg overflow-hidden">
              ...
              <div className="rounded-t-2xl border-b border-slate-200 bg-gradient-to-r from-amber-800 to-amber-900 p-6">
                <div className="flex items-center gap-5">
                  <span
                    className="grid h-20 w-20 place-items-center rounded-full bg-white text-2xl font-black uppercase tracking-wide text-amber-900"
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 text-sm font-medium text-amber-200">
                      Observación Grupal · Evaluación Individual
                    </p>
                  </div>
                  <div className="hidden sm:flex flex-col items-end gap-1">
                    <span className="rounded-full bg-white px-4 py-2 text-sm font-black text-amber-900">
                ...
                {rubricCriteria.map((criterion, cIdx) => (
                  <div key={criterion.criterionId} className="p-5">
                    <div className="mb-4 flex items-start gap-3">
                      <span className="grid h-8 w-8 flex-shrink-0 place-items-center rounded-lg bg-amber-900 text-sm font-black text-white">
                        {cIdx + 1}
                      </span>
                      <div className="min-w-0 flex-1">
                        <p
                                ...
                                : isSelected && isPorLograr
                                  ...
                                  : isSelected && isNoLogrado
                                    ...
                                    : isSelected
                                      ...
                                      : "border-slate-200 bg-white hover:border-amber-400 hover:shadow-sm disabled:bg-slate-50 disabled:text-slate-400"
                            }`}
                          >

...
import UsersDataTable from '../../../admin/components/admin/UsersDataTable';
import ApplicationsDataTable from './ApplicationsDataTable';
import PostulantesDataTable from '../../../admin/components/admin/PostulantesDataTable';
import EvaluationsDataTable from '../../../admin/components/admin/EvaluationsDataTable';
import EvaluationsOverviewTable from '../../../admin/components/admin/EvaluationsOverviewTable';
import EmailNotificationsTable from '../../../admin/components/admin/EmailNotificationsTable';
import NotificationConfigPanel from '../../../admin/components/admin/NotificationConfigPanel';
import EmailTemplateManager from '../../../admin/components/admin/EmailTemplateManager';
import ReportsView from '../../../admin/components/admin/ReportsView';
import AnalyticsView from '../../../admin/components/admin/AnalyticsView';
import Modal from '../../../admin/components/ui/Modal';
import UserForm from '../../../admin/components/users/UserForm';
import { UserFormMode } from '../../../admin/types/user';
